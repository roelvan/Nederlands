...
$definitions["%s can view this conversation.plural"] = "%s kunnen dit onderwerp bekijken.";
...
$definitions["%s will be able to view this conversation."] = "%s mag dit onderwerp bekijken.";
$definitions["%s will be able to view this conversation.plural"] = "%s mogen dit onderwerp bekijken.";
...
$definitions["a private conversation"] = "een privébericht";
$definitions["Automatically follow conversations that I reply to"] = "Volg onderwerpen automatisch waarin ik reageer";
$definitions["Automatically follow private conversations that I'm added to"] = "Volg privéberichten automatisch";
...
$definitions["Email me when I'm added to a private conversation"] = "Email mij wanneer ik ben toegevoegd aan een privébericht";
...
$definitions["Enable"] = "Inschakelen";
$definitions["Enabled"] = "Ingeschakeld";
...
$definitions["See the private conversations I've had with %s"] = "Toon de privéberichten die ik heb gehad met %s";
...
$definitions["Start a private conversation with %s"] = "Start een privébericht met %s";
...
$definitions["message.suspendMemberHelp"] = "%s deactiveren zorgt ervoor dat hij niet meer kan reageren op onderwerpen, geen onderwerpen meer kan starten of privéberichten meer kan bekijken. Feitelijk heeft hij hierdoor dezelfde rechten als een gast.";
...
$definitions["gambit.starred"] = "gevolgd";
